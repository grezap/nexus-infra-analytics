...
variable "iso_url" {
  ...
  description = "Debian 13.5.0 netinst ISO (same point release + hash as nexus-infra-oltp's per-engine templates). Override via `-var iso_url=H:/VMS/ISO/debian-13.5.0-amd64-netinst.iso` to consume the local cache per memory/project_iso_directory.md."
}
