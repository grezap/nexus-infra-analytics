...
| 0.G.6 | StarRocks (3 FE + 3 BE, shared-nothing) | **LIVE-RATIFIED 2026-05-23** (cold-rebuild pending); CN/shared-data tier deferred to 0.L | `smoke-0.G.6.ps1` → 73/73 |
